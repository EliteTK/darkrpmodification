--[[
-- - Removed the ability to lockpick fading doors
-- - Adjusted lockpicking time to be between 20 and 30 seconds to push people towards using
--   the fast pick.
-- - 
--]]
...
SWEP.Author = "Base: DRP Devs | Extension: EliteTK"
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		...
		self.LockPickTime = math.Rand(20, 30)
